...
var floatPrecision = null;
function testPrecisionSupport(precisionType) {
var format = gl.getShaderPrecisionFormat(gl.FRAGMENT_SHADER, precisionType);
...
fragmentSource = 'precision ' + floatPrecision + ' float;' + fragmentSource;
